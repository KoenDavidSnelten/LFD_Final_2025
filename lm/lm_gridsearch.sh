...
PROCESS_STEP="raw"
OUTPUT="/scratch/$USER/LFD_Final_2025/lm/output/$PROCESS_STEP/"
...
checkpoint_dir="$OUTPUT/lr_${lr}_bs_${batch_size}_ml_${max_len}_pat_${patience}"

# NEW: Construct the full command as a variable for logging
COMMAND="python3 ./lm_model.py \

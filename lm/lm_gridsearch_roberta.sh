...
#SBATCH --output=/scratch/%u/LFD_Final_2025/lm/output/raw_roberta/slurm_logs/slurm-%A_%a.out
...
MODEL="roberta-base"
EPOCHS="15"
BASE_OUTPUT_DIR="/scratch/$USER/LFD_Final_2025/lm/output/raw_roberta"
...
NUM_PATIENCE_VALUES=${#PATIENCE_VALUES[@]} # 3
